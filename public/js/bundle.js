        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'you successfully logged in');
...
var displayMapBox = function displayMapBox(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiMjUzMG1hIiwiYSI6ImNsNTZkNHFsMjAyY3czZHFsNTVqcmRmM3oifQ.fWyzaD4gWQeCmmxjw3kPpA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // adding pop up

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //3 extend the map bound to include the current location current
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), "successfully cahnged"));
            }
...
var formUserForm = document.querySelector('.form-user-data');
...
if (formUserForm) {
  formUserForm.addEventListener('submit', function (e) {
    e.preventDefault();
